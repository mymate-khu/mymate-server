...
public enum TokenErrorStatus implements ErrorResponse {
    ...
    ACCESS_TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED, "TOKEN4003", "Access 토큰이 만료되었습니다. 토큰을 갱신해주세요."),
    INVALID_REFRESH_TOKEN(HttpStatus.UNAUTHORIZED, "TOKEN4004", "유효하지 않거나 변조된 Refresh 토큰입니다."),
    REFRESH_TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED, "TOKEN4005", "Refresh 토큰이 만료되었습니다. 다시 로그인해주세요."),
    INVALID_CONTEXT(HttpStatus.UNAUTHORIZED, "TOKEN4006", "리프레시 토큰 컨텍스트가 일치하지 않습니다."),
